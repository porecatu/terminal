...
|---|---|---|---|
| Interface | `Iosevka Aile` | 400, 500, 600 | títulos de aba, rótulos de grupo, menus, configurações |
...
As famílias de texto eram IBM Plex Sans e IBM Plex Mono até o [ADR-0025](../adr/0025-iosevka-no-lugar-da-ibm-plex.md), que as trocou pela Iosevka: a Plex Mono não cobre braille, formas geométricas, dingbats nem powerline, e o mockup, o `btop` e o Claude Code CLI precisam dos quatro. O **mockup ainda mostra IBM Plex** — divergência registrada na seção 4.4.
